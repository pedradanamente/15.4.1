<div class="topdiv" style="min-height:200px;color:#FFF;background-color:rgba(0, 0, 0, 0.6);">
	<div class="navbar">
		...
		<h1 class="fl" style="margin-top:5px;">FINANCIAMENTO</h1>
...
?>
	<div>	
		<form method="post" action="post/salvarajax.php">
			<textarea class="textareajax" rows="30"  onkeyup="salvarajax();" id="texto"><?php if (!empty($texto)) { echo $texto; } ?></textarea>
...
<?php
	...
	?>
		<textarea class="textareajax" style="background-color:rgba(0,0,0,0);" rows="30" id="texto" disabled><?php if (!empty($texto)) { echo $texto; } ?></textarea>
		<input type="text" id="cpf" value="<?php echo $_SESSION['cpf']; ?>" style="display:none;"/>
<?php
}
?>
